...
typedef struct {
  ...
  qhandle_t q3Portraits[MAX_PLAYERMODELS]; // leilei - displaying portraits with
                                           // deferred loading for some screens
  int q3SelectedHead;
  ...
  playerInfo_t info;
  // end changed RD
  int q3HeadCount2; // leilei - a complete list for the text list. for saving
                    // vram
