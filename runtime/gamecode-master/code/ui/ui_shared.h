...
#define WINDOW_FORECOLORSET                                                    \
  0x00000200 // forecolor was explicitly set ( used to color alpha images or not
             // )
...
typedef struct itemDef_s {
  ...
  const char *enableCvar; // enable, disable, show, or hide based on value, this
                          // can contain a list
...
// Adapted from an i3d thread that applies this to the JK2 source
// http://forums.inside3d.com/viewtopic.php?f=1&t=5159&p=49084
