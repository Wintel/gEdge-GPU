...
gitem_t bg_itemlist[] = {
    ...
    {"item_armor_shard",
     ...
     {"models/powerups/armor/shard.md3",
      "models/powerups/armor/shard_sphere.md3", NULL, NULL},
    ...
    {"item_health_small",
     ...
     {"models/powerups/health/small_cross.md3",
      "models/powerups/health/small_sphere.md3", NULL, NULL},
    ...
    {"item_health",
     ...
     {"models/powerups/health/medium_cross.md3",
      "models/powerups/health/medium_sphere.md3", NULL, NULL},
    ...
    {"item_health_large",
     ...
     {"models/powerups/health/large_cross.md3",
      "models/powerups/health/large_sphere.md3", NULL, NULL},
    ...
    {"item_health_mega",
     ...
     {"models/powerups/health/mega_cross.md3",
      "models/powerups/health/mega_sphere.md3", NULL, NULL},
    ...
    {"holdable_medkit",
     ...
     {"models/powerups/holdable/medkit.md3",
      "models/powerups/holdable/medkit_sphere.md3", NULL, NULL},
     /* icon */ "icons/medkit",
     /* pickup */ "Medkit",
     60,
     IT_HOLDABLE,
    ...
    {"item_quad",
     ...
     {"models/powerups/instant/quad.md3",
      "models/powerups/instant/quad_ring.md3", NULL, NULL},
     /* icon */ "icons/quad",
     /* pickup */ "Quad Damage",
     30,
     IT_POWERUP,
    ...
    {"item_enviro",
     ...
     {"models/powerups/instant/enviro.md3",
      "models/powerups/instant/enviro_ring.md3", NULL, NULL},
    ...
    {"item_haste",
     ...
     {"models/powerups/instant/haste.md3",
      "models/powerups/instant/haste_ring.md3", NULL, NULL},
     /* icon */ "icons/haste",
     /* pickup */ "Speed",
     30,
     IT_POWERUP,
    ...
    {"item_invis",
     ...
     {"models/powerups/instant/invis.md3",
      "models/powerups/instant/invis_ring.md3", NULL, NULL},
     /* icon */ "icons/invis",
     /* pickup */ "Invisibility",
     30,
     IT_POWERUP,
    ...
    {"item_regen",
     ...
     {"models/powerups/instant/regen.md3",
      "models/powerups/instant/regen_ring.md3", NULL, NULL},
     /* icon */ "icons/regen",
     /* pickup */ "Regeneration",
     30,
     IT_POWERUP,
    ...
    {"item_flight",
     ...
     {"models/powerups/instant/flight.md3",
      "models/powerups/instant/flight_ring.md3", NULL, NULL},
     /* icon */ "icons/flight",
     /* pickup */ "Flight",
     60,
     IT_POWERUP,
    ...
    /*QUAKED holdable_invulnerability (.3 .3 1) (-16 -16 -16) (16 16 16)
     * suspended
     */
    ...
    //
    /*QUAKED item_scout (.3 .3 1) (-16 -16 -16) (16 16 16) suspended redTeam
     * blueTeam
     */
    {"item_scout",
    ...
    /*QUAKED item_guard (.3 .3 1) (-16 -16 -16) (16 16 16) suspended redTeam
     * blueTeam
     */
    {"item_guard",
    ...
    /*QUAKED item_doubler (.3 .3 1) (-16 -16 -16) (16 16 16) suspended redTeam
     * blueTeam
     */
    {"item_doubler",
...
Only in One Flag CTF games
    ...
    {"team_DD_pointAblue",
     NULL,
     {"models/dpoints/a_blue.md3", NULL, NULL, NULL},
    ...
    {"team_DD_pointBblue",
     NULL,
     {"models/dpoints/b_blue.md3", NULL, NULL, NULL},
    ...
    {"team_DD_pointAred",
     NULL,
     {"models/dpoints/a_red.md3", NULL, NULL, NULL},
    ...
    {"team_DD_pointBred",
     NULL,
     {"models/dpoints/b_red.md3", NULL, NULL, NULL},
    ...
    {"team_DD_pointAwhite",
     NULL,
     {"models/dpoints/a_white.md3", NULL, NULL, NULL},
    ...
    {"team_DD_pointBwhite",
     NULL,
     {"models/dpoints/b_white.md3", NULL, NULL, NULL},
...
qboolean BG_CanItemBeGrabbed(int gametype, const entityState_t *ent,
  ...
  case IT_PERSISTANT_POWERUP:
    ...
    // In Double D we don't want persistant Powerups (or maybe, can be
    // discussed)
  ...
  case IT_TEAM: // team items, such as flags
    ...
    if (gametype == GT_CTF || gametype == GT_CTF_ELIMINATION) {
      ...
      // we need to know this because we can pick up our dropped flag (and
      // return it) but we can't pick up our flag at base
      if (ps->persistant[PERS_TEAM] == TEAM_RED) {
...
char *eventnames[] = {
    ...
    // Not all of these are used in baseoa but we keep them to gurantie event
    // numbers between version
...
#define SUPPORT_GAMETYPE_PREFIX "support_"
    if (Q_strequaln(keyBuffer, SUPPORT_GAMETYPE_PREFIX,
                    sizeof(SUPPORT_GAMETYPE_PREFIX) - 1)) {
      // Com_Printf("Saw %s, gametype part: %s\n", token,
      // &token[sizeof(SUPPORT_GAMETYPE_PREFIX)-1]);
      for (i = 0; i < GT_MAX_GAME_TYPE; ++i) {
        if (MatchesGametype(i,
                            &keyBuffer[sizeof(SUPPORT_GAMETYPE_PREFIX) - 1])) {
