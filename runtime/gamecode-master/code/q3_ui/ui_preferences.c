...
static const char *teamoverlay_names[] = {"off", "upper right", "lower right",
                                          "lower left", NULL};

static void Preferences_SetMenuItems(void) {
  s_preferences.crosshair.curvalue =
      (int)trap_Cvar_VariableValue("cg_drawCrosshair") % NUM_CROSSHAIRS;
  s_preferences.crosshairHealth.curvalue =
      trap_Cvar_VariableValue("cg_crosshairHealth") != 0;
  s_preferences.crosshairColorRed.curvalue =
      trap_Cvar_VariableValue("cg_crosshairColorRed") * 255.0f;
  s_preferences.crosshairColorGreen.curvalue =
      trap_Cvar_VariableValue("cg_crosshairColorGreen") * 255.0f;
  s_preferences.crosshairColorBlue.curvalue =
      trap_Cvar_VariableValue("cg_crosshairColorBlue") * 255.0f;
  s_preferences.simpleitems.curvalue =
      trap_Cvar_VariableValue("cg_simpleItems") != 0;
  s_preferences.alwaysweaponbar.curvalue =
      trap_Cvar_VariableValue("cg_alwaysWeaponBar") != 0;
  ...
  s_preferences.dynamiclights.curvalue =
      trap_Cvar_VariableValue("r_dynamiclight") != 0;
  s_preferences.highqualitysky.curvalue =
      trap_Cvar_VariableValue("r_fastsky") == 0;
  s_preferences.synceveryframe.curvalue =
      trap_Cvar_VariableValue("r_finish") != 0;
  s_preferences.forcemodel.curvalue =
      trap_Cvar_VariableValue("cg_forcemodel") != 0;
  s_preferences.drawteamoverlay.curvalue =
      Com_Clamp(0, 3, trap_Cvar_VariableValue("cg_drawTeamOverlay"));
  s_preferences.allowdownload.curvalue =
      trap_Cvar_VariableValue("cl_allowDownload") != 0;
  s_preferences.delaghitscan.curvalue =
      trap_Cvar_VariableValue("cg_delag") != 0;
  s_preferences.chatbeep.curvalue = trap_Cvar_VariableValue("cg_chatBeep") != 0;
  s_preferences.teamchatbeep.curvalue =
      trap_Cvar_VariableValue("cg_teamChatBeep") != 0;
}
...
static void Preferences_Event(void *ptr, int notification) {
  ...
  case ID_CROSSHAIR:
    ...
    if (s_preferences.crosshair.curvalue == NUM_CROSSHAIRS ||
        s_preferences.crosshairShader[s_preferences.crosshair.curvalue] == 0) {
  ...
  case ID_CROSSHAIRHEALTH:
    trap_Cvar_SetValue("cg_crosshairHealth",
                       s_preferences.crosshairHealth.curvalue);
  ...
  case ID_COLORRED:
    trap_Cvar_SetValue("cg_crosshairColorRed",
                       ((float)s_preferences.crosshairColorRed.curvalue) /
                           255.f);
    break;

  case ID_COLORGREEN:
    trap_Cvar_SetValue("cg_crosshairColorGreen",
                       ((float)s_preferences.crosshairColorGreen.curvalue) /
                           255.f);
    break;

  case ID_COLORBLUE:
    trap_Cvar_SetValue("cg_crosshairColorBlue",
                       ((float)s_preferences.crosshairColorBlue.curvalue) /
                           255.f);
    break;
...
static void Preferences_Menu_AddBoolean(menuradiobutton_s *menutext, int *y,
                                        int id, char *text) {
...
static void Preferences_MenuInit(void) {
  ...
  s_preferences.crosshair.generic.flags =
      QMF_PULSEIFFOCUS | QMF_SMALLFONT | QMF_NODEFAULTINIT | QMF_OWNERDRAW;
  ...
  s_preferences.crosshair.generic.left =
      PREFERENCES_X_POS -
      ((strlen(s_preferences.crosshair.generic.name) + 1) * SMALLCHAR_WIDTH);
  ...
  s_preferences.crosshairHealth.generic.flags =
  ...
  s_preferences.crosshairColorRed.generic.flags =
      QMF_PULSEIFFOCUS | QMF_SMALLFONT;
  ...
  s_preferences.crosshairColorGreen.generic.flags =
      QMF_PULSEIFFOCUS | QMF_SMALLFONT;
  ...
  s_preferences.crosshairColorBlue.generic.flags =
      QMF_PULSEIFFOCUS | QMF_SMALLFONT;
  ...
  Preferences_Menu_AddBoolean(&s_preferences.simpleitems, &y, ID_SIMPLEITEMS,
                              "Simple Items:");
  Preferences_Menu_AddBoolean(&s_preferences.alwaysweaponbar, &y, ID_WEAPONBAR,
                              "Always show weapons:");
  Preferences_Menu_AddBoolean(&s_preferences.wallmarks, &y, ID_WALLMARKS,
                              "Marks on Walls:");
  Preferences_Menu_AddBoolean(&s_preferences.brass, &y, ID_EJECTINGBRASS,
                              "Ejecting Brass:");
  Preferences_Menu_AddBoolean(&s_preferences.dynamiclights, &y,
                              ID_DYNAMICLIGHTS, "Dynamic Lights:");
  Preferences_Menu_AddBoolean(&s_preferences.identifytarget, &y,
                              ID_IDENTIFYTARGET, "Identify Target:");
  Preferences_Menu_AddBoolean(&s_preferences.highqualitysky, &y,
                              ID_HIGHQUALITYSKY, "High Quality Sky:");
  Preferences_Menu_AddBoolean(&s_preferences.synceveryframe, &y,
                              ID_SYNCEVERYFRAME, "Sync Every Frame:");
  Preferences_Menu_AddBoolean(&s_preferences.forcemodel, &y, ID_FORCEMODEL,
                              "Force Player Models:");
  ...
  Preferences_Menu_AddBoolean(&s_preferences.delaghitscan, &y, ID_DELAGHITSCAN,
                              "Unlag hitscan:");
  Preferences_Menu_AddBoolean(&s_preferences.allowdownload, &y,
                              ID_ALLOWDOWNLOAD, "Automatic Downloading:");
  Preferences_Menu_AddBoolean(&s_preferences.chatbeep, &y, ID_CHATBEEP,
                              "Beep on chat:");
  Preferences_Menu_AddBoolean(&s_preferences.teamchatbeep, &y, ID_TEAMCHATBEEP,
                              "Beep on team chat:");
...
void Preferences_Cache(void) {
  ...
  for (n = 0; n < NUM_CROSSHAIRS; n++) {
    if (n < 10)
      ...
      s_preferences.crosshairShader[n] =
          trap_R_RegisterShaderNoMip(va("gfx/2d/crosshair%02d", n - 10));
  }
}
