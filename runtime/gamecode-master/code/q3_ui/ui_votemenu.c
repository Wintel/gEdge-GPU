...
static char *votemenu_artlist[] = {VOTEMENU_BACK0, VOTEMENU_BACK1, ART_FIGHT0,
                                   ART_FIGHT1, NULL};
...
void UI_VoteMenuMenuInternal(void) {
  ...
  s_votemenu.back.generic.y =
      256 + 128 - 64 + VOTEMENU_MENU_VERTICAL_SPACING * 2;
...
void UI_VoteMenuMenu(void) {
  ...
  s_votemenu.g_doWarmupEnabled =
      atoi(Info_ValueForKey(serverinfo, "g_doWarmup"));
  UI_VoteMenuMenuInternal();
