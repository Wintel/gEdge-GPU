...
static char *votemenu_Timelmit_artlist[] = {VOTEMENU_BACK0, VOTEMENU_BACK1,
...
static void setTimeMenutext(menutext_s *menu, int y, int id, int value,
                            char *text) {
...
void UI_VoteTimelimitMenu(void) {
  ...
  s_votemenu_Timelmit.min =
      atoi(Info_ValueForKey(serverinfo, "g_voteMinTimelimit"));
  s_votemenu_Timelmit.max =
      atoi(Info_ValueForKey(serverinfo, "g_voteMaxTimelimit"));
  UI_VoteTimelimitMenuInternal();
  ...
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimit10);
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimit15);
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimit20);
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimit30);
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimit40);
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimit50);
  Menu_AddItem(&s_votemenu_Timelmit.menu,
               (void *)&s_votemenu_Timelmit.bLimitInf);
