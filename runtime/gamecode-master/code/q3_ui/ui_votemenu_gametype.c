...
static char *votemenu_Gametype_artlist[] = {VOTEMENU_BACK0, VOTEMENU_BACK1,
                                            ART_FIGHT0, ART_FIGHT1, NULL};
...
static void setGametypeMenutext(menutext_s *menu, int y, int id,
                                qboolean active, char *text) {
...
void UI_VoteGametypeMenuInternal(void) {
  ...
  y = 98;
  setGametypeMenutext(&s_votemenu_Gametype.bFFA, y, ID_FFA,
                      s_votemenu_Gametype.FFA, "Free for all");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bTourney, y, ID_Tourney,
                      s_votemenu_Gametype.Tourney, "Tournament");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bTDM, y, ID_TDM,
                      s_votemenu_Gametype.TDM, "Team Deathmatch");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bCTF, y, ID_CTF,
                      s_votemenu_Gametype.CTF, "Capture the flag");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.b1FCTF, y, ID_1FCTF,
                      s_votemenu_Gametype._1FCTF, "One flag capture");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bOverload, y, ID_Overload,
                      s_votemenu_Gametype.Overload, "Overload");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bHarvester, y, ID_Harvester,
                      s_votemenu_Gametype.Harvester, "Harvester");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bElimination, y, ID_Elimination,
                      s_votemenu_Gametype.Elimination, "Elimination");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bCTFe, y, ID_CTFe,
                      s_votemenu_Gametype.CTFe, "CTF Elimination");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bLMS, y, ID_LMS,
                      s_votemenu_Gametype.LMS, "Last man standing");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bDOUBLED, y, ID_DOUBLED,
                      s_votemenu_Gametype.DOUBLED, "Double Domination");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bDOM, y, ID_DOM,
                      s_votemenu_Gametype.DOM, "Domination");
  y += Gametype_MENU_VERTICAL_SPACING;
  setGametypeMenutext(&s_votemenu_Gametype.bPOS, y, ID_POS,
                      s_votemenu_Gametype.POS, "Possession");
  y += Gametype_MENU_VERTICAL_SPACING;
...
void UI_VoteGametypeMenu(void) {
  ...
  Menu_AddItem(&s_votemenu_Gametype.menu,
               (void *)&s_votemenu_Gametype.bTourney);
  ...
  Menu_AddItem(&s_votemenu_Gametype.menu,
               (void *)&s_votemenu_Gametype.bOverload);
  Menu_AddItem(&s_votemenu_Gametype.menu,
               (void *)&s_votemenu_Gametype.bHarvester);
  Menu_AddItem(&s_votemenu_Gametype.menu,
               (void *)&s_votemenu_Gametype.bElimination);
  ...
  Menu_AddItem(&s_votemenu_Gametype.menu,
               (void *)&s_votemenu_Gametype.bDOUBLED);
