...
static void populatePlayerList(void) {
  ...
  for (i = 0; i < MAX_CLIENTS; i++) {
    ...
    if (strlen(playerinfo)) {
      ...
      Q_strncpyz(
          s_votemenu_kick.players_profiles[s_votemenu_kick.numPlayers].name,
          Info_ValueForKey(playerinfo, "n"), SIZE_OF_NAME - 2);
...
static void VoteKickMenu_Event(void *ptr, int event) {
  ...
  default:
    ...
    trap_Cmd_ExecuteText(
        EXEC_APPEND, va("callvote clientkick %d",
                        s_votemenu_kick
                            .players_profiles[(s_votemenu_kick.selected - 20) +
...
static void setKickMenutext(menutext_s *menu, int y, int id, qboolean active,
                            char *text) {
...
void UI_VoteKickMenuInternal(void) {
  ...
  y = 98;
  setKickMenutext(
      &s_votemenu_kick.players[0], y, ID_PLAYERNAME0,
      s_votemenu_kick.startIndex < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[1], y, ID_PLAYERNAME1,
      s_votemenu_kick.startIndex + 1 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 1].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[2], y, ID_PLAYERNAME2,
      s_votemenu_kick.startIndex + 2 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 2].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[3], y, ID_PLAYERNAME3,
      s_votemenu_kick.startIndex + 3 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 3].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[4], y, ID_PLAYERNAME4,
      s_votemenu_kick.startIndex + 4 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 4].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[5], y, ID_PLAYERNAME5,
      s_votemenu_kick.startIndex + 5 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 5].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[6], y, ID_PLAYERNAME6,
      s_votemenu_kick.startIndex + 6 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 6].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[7], y, ID_PLAYERNAME7,
      s_votemenu_kick.startIndex + 7 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 7].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[8], y, ID_PLAYERNAME8,
      s_votemenu_kick.startIndex + 8 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 8].name);
  y += VOTEKICK_MENU_VERTICAL_SPACING;
  setKickMenutext(
      &s_votemenu_kick.players[9], y, ID_PLAYERNAME9,
      s_votemenu_kick.startIndex + 9 < s_votemenu_kick.numPlayers,
      s_votemenu_kick.players_profiles[s_votemenu_kick.startIndex + 9].name);
