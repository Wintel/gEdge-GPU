...
static const char *quality_items[] = {"Low", "High", NULL};
...
static void UI_SoundOptionsMenu_Event(void *ptr, int event) {
  ...
  case ID_QUALITY:
    ...
    /*
            case ID_A3D:
                    ...
                    soundOptionsInfo.a3d.curvalue =
       (int)trap_Cvar_VariableValue( "s_usingA3D" ); break;
    */
  ...
  case ID_OPENAL:
    ...
    soundOptionsInfo.openal.curvalue =
        (int)trap_Cvar_VariableValue("s_useopenal");
    break;
...
static void UI_SoundOptionsMenu_Init(void) {
  ...
  /*
          y += BIGCHAR_HEIGHT+2;
          soundOptionsInfo.a3d.generic.type			=
     MTYPE_RADIOBUTTON; soundOptionsInfo.a3d.generic.name = "A3D:";
          soundOptionsInfo.a3d.generic.flags			=
     QMF_PULSEIFFOCUS|QMF_SMALLFONT; soundOptionsInfo.a3d.generic.callback
     = UI_SoundOptionsMenu_Event; soundOptionsInfo.a3d.generic.id
     = ID_A3D; soundOptionsInfo.a3d.generic.x				= 400;
  ...
  */
  ...
  soundOptionsInfo.musicvolume.curvalue =
      trap_Cvar_VariableValue("s_musicvolume") * 10;
  soundOptionsInfo.quality.curvalue = !trap_Cvar_VariableValue("s_compression");
  //	soundOptionsInfo.a3d.curvalue = (int)trap_Cvar_VariableValue(
  //"s_usingA3D" );
  soundOptionsInfo.openal.curvalue =
      (int)trap_Cvar_VariableValue("s_useopenal");
}
