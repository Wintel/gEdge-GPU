...
// #define INGAME_FRAME					"menu/" MENU_ART_DIR
// "/cut_frame"
...
void InGame_MenuInit(void) {
  ...
  if (!trap_Cvar_VariableValue("sv_running") ||
      !trap_Cvar_VariableValue("bot_enable") || gametype == GT_SINGLE_PLAYER) {
  ...
  if (atoi(Info_ValueForKey(info, "g_allowVote")) == 0 ||
...
=================
*/
void InGame_Cache(void) { trap_R_RegisterShaderNoMip(INGAME_FRAME); }
