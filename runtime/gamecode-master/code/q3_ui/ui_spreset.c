...
static void Reset_MenuDraw(void) {
  ...
  UI_DrawProportionalString(320, 194 + 10, "RESET GAME?",
                            UI_CENTER | UI_INVERSE, color_red);
  UI_DrawProportionalString(s_reset.slashX, 265, "/", UI_LEFT | UI_INVERSE,
                            color_red);
...
=================
*/
void Reset_Cache(void) { trap_R_RegisterShaderNoMip(ART_FRAME); }
