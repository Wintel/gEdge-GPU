 ...
 * @param destsize size of the destination array, at most destsize-1 will be
 * copied
 */
void Q_strncpyz(char *dest, const char *src, int destsize);
/**
 * Appends a string to another string. The function protects against overflow.
 * The size is the max size of the destination AFTER the string has been
 * appended If the length of dest is larger or equal to destsize then nothing
 * will be appended.
 *
...
#define CVAR_SERVER_CREATED                                                    \
  2048 // cvar was created by a server the client connected to.
