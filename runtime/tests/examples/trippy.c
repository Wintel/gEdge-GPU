...
#define MAXSIZE                                                                \
  512 /* Set this to your maximum texture size (square)                        \
       */
#define TEXT "OpenGL"
...
void mode_menu(int i) { smooth = i; }

void seed_menu(int i) { seedmode = i; }

void prim_menu(int i) { primtype = i; }

void size_menu(int i) { seedsize = 1.0 / i; }
...
int mainmenu;
int modemenu, seedmenu, primmenu, sizemenu, psizemenu, nomenu, colourmenu;
...
int main(int argc, char **argv) {
  fprintf(stderr, "This program demonstrates a feature which is not in OpenGL "
                  "Version 1.0.\n");
  fprintf(stderr, "If your implementation of OpenGL Version 1.0 has the right "
                  "extensions,\n");
